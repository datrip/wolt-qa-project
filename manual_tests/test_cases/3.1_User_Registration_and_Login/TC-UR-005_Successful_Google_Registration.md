...
**Test Objective**: Verify that a new user can successfully complete the registration process on the Wolt website using Google Sign-In, including Google authentication and phone number confirmation, and access their account.
...
**Test Data**:
- **Google Account**: testwoltuser@gmail.com
- **Google Account Password**: TestWoltUser123!
- **First Name**: Vardas
- **Last Name**: Pavardė
...
**Screenshot**: [Wolt Homepage](../../images/TC-UR-005/TC-UR-005_Homepage.png)
...
**Screenshot**: [Registration Modal Opens](../../images/TC-UR-005/TC-UR-005_Signup_Modal.png)
...
**Screenshot**: [Google Sign-In Form](../../images/TC-UR-005/TC-UR-005_Google_Signin_Page.png)
...
**Screenshot**: [Registration Form Displayed](../../images/TC-UR-005/TC-UR-005_Registration_Form.png)
...
**Screenshot**: [Notification Preferences Modal](../../images/TC-UR-005/TC-UR-005_Registration_Promotion_Yes.png)
...
**Screenshot**: [Phone Verification Modal](../../images/TC-UR-005/TC-UR-005_Registration_SMS_Verify.png)
...
**Screenshot**: [Phone Number Verified Message](../../images/TC-UR-005/TC-UR-005_Registration_SMS_Verify_Confirmed.png)
...
**Screenshot**: [Logged In Successfully](../../images/TC-UR-005/TC-UR-005_Logged_In.png)
